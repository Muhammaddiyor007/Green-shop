			...
			<div className='py-[30px]'>
				<form action=''>
					<Space.Compact style={{ width: '100%' }}>
						<Input defaultValue='' />
						<button className='bg-[#46A538] text-white px-3 py-2 font-semibold rounded-[5px]' type='primary'>Apply</button>
					</Space.Compact>
				</form>
				<div className="text-[#00000073] text-[14px] grid gap-[16px] mt-[16px]">
					...
					<button className='w-full py-[10px] bg-[#46A538] text-[#ffffff] text-[16px] font-bold rounded-[8px]'>Proceed to Checkout</button>
